...
#'
#' @param CellChatDB CellChatDB databse
#' @param search a character vector; When `key` is a vector, the `search` should be a list with the size being `length(key)`, where each element is a character vector
