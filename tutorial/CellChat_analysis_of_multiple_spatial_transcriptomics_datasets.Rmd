...
scale.factors1 = data.frame(ratio = conversion.factor1, tol = spot.size/2)
...
scale.factors2 = data.frame(ratio = conversion.factor2, tol = spot.size/2)

scale.factors <- rbind(scale.factors1, scale.factors2)
rownames(scale.factors) <- c("A1", "A2")
