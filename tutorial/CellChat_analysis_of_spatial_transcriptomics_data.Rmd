...
meta = data.frame(labels = Idents(visium.brain), slices = "slice1", row.names = names(Idents(visium.brain))) # manually create a dataframe consisting of the cell labels
